...
public class PWA2_ClientEditProfile extends BaseClass {
	...
	public static void EditProfile() throws Throwable {
		...
		Clear("PwaEditProfileName");
		LogInfo("Profile name is cleared");
		
		TypeDataInTheElement("PwaEditProfileName", ClientExcel(1, 1, "Edit Profile"));
		LogInfo("Profile name is entered as : "+ ClientExcel(1, 1, "Edit Profile"));
